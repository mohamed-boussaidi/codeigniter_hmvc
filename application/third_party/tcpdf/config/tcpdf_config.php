 ...
 * @package com.Mind.Engineering.tcpdf
 * @version 4.9.005
 * @since 2004-10-27
 */
 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'Mind Engineering');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Mind Engineering');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Par Mind Engineering\nwww.mind.engineering");
